...
## 5. Whenever you made a functional code change, the related parts of spec and design documents must be updated.

## 6. Deploy the latest Windows test build after each iteration
